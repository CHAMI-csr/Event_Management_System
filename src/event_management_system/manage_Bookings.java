...
public class manage_Bookings extends javax.swing.JInternalFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger
            .getLogger(manage_Bookings.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel11.setForeground(new java.awt.Color(230, 230, 255));
        jLabel11.setText("Advance");

        txtAdvance.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N

        jLabel12.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(230, 230, 255));
        jLabel12.setText("Balance");

        txtBalance.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N

        cmbPaymentStatus.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N

        jLabel17.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(230, 230, 255));
        ...
        NextBid.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        NextBid.setForeground(new java.awt.Color(90, 120, 240));
        ...
        txtEventDate.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(230, 230, 255));
        jLabel6.setText("Event Date");

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(230, 230, 255));
        jLabel7.setText("Start Time");

        txtStartTime.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(230, 230, 255));
        jLabel8.setText("Venue");

        txtVenue.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(230, 230, 255));
        jLabel9.setText("Guest Count");

        txtGuestCount.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N

        btnCustomize.setBackground(new java.awt.Color(200, 130, 30));
        btnCustomize.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                .addComponent(cmbContact, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(txtName, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 292, Short.MAX_VALUE)))
                                        .addGap(0, 0, Short.MAX_VALUE))
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addComponent(cmbPackage, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void suggestPackages(String text) {
        ...
        try (
                java.sql.Connection conn = DBConnect.connect();
                java.sql.PreparedStatement stmt = conn.prepareStatement(
                        "SELECT package_id, package_name FROM package WHERE package_name LIKE ? OR package_id LIKE ?");) {
            stmt.setString(1, "%" + text + "%");
    ...
    private void fetchClientDetails(String contactNo) {
        try {
            ...
            if (rs.next()) {
                ...
                txtName.setText("");
                JOptionPane.showMessageDialog(this, "New Client! Please enter the Name.", "Info",
    ...
    private void addBookingActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            if (contactNo.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please enter Client Contact Number.", "Validation Error",
            ...
            if (clientName.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Client Name is empty. Please select a valid contact.",
                        "Validation Error", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            Object pkgItem = cmbPackage.getSelectedItem();
            if (pkgItem == null || pkgItem.toString().trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please select a Package.", "Validation Error",
                        JOptionPane.WARNING_MESSAGE);
            ...
            if (selectedDate == null) {
                JOptionPane.showMessageDialog(this, "Please select Event Date.", "Validation Error",
                        JOptionPane.WARNING_MESSAGE);
            ...
            if (startTimeItem == null || startTimeItem.toString().trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please select Start Time.", "Validation Error",
                        JOptionPane.WARNING_MESSAGE);
            ...
            if (venue.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please enter Venue.", "Validation Error",
                        JOptionPane.WARNING_MESSAGE);
            ...
            if (guestCount <= 0) {
                JOptionPane.showMessageDialog(this, "Guest Count must be greater than 0.", "Validation Error",
                        JOptionPane.WARNING_MESSAGE);
            ...
            if (totalStr.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please enter Total Amount.", "Validation Error",
                        JOptionPane.WARNING_MESSAGE);
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Total Amount and Advance must be valid numbers.",
                        "Validation Error", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            if (clientId == null) {
                JOptionPane.showMessageDialog(this,
                        "Client not found for contact: " + contactNo + "\nPlease register the client first.", "Error",
            ...
            JOptionPane.showMessageDialog(this, "Error saving booking: " + e.getMessage(), "Database Error",
                    JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
    ...
    private void calculateBalance() {
        try {
            double total = txtTotalAmount.getText().trim().isEmpty() ? 0
                    : Double.parseDouble(txtTotalAmount.getText().trim());
            double advance = txtAdvance.getText().trim().isEmpty() ? 0
                    : Double.parseDouble(txtAdvance.getText().trim());
