...
public class Event_Schedule extends javax.swing.JInternalFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Event_Schedule.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Event_Schedule().setVisible(true));
    }
